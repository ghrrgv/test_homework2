...
def test_find_suitable_user():
    ...
    for user_age in users:
        if user_age['age'] <= 20:
            suitable_users.append(user_age)
...
def open_browser(browser_name):
    actual_result = str(open_browser.__name__.replace('_', ' ').title()) + f' [{browser_name}]' #  первый символ - заглавный
